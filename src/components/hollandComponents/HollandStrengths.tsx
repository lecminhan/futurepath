import { getHollandStrengths } from '../../utils/hollandUtils';

interface Props {
  code: string;
}

const HollandStrengths: React.FC<Props> = ({ code }) => {
  const strengths = getHollandStrengths(code); // trả về mảng các {title, description}
