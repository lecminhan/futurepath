    ...
    <div>
      ...
      >
        <Container>
          ...
          <p style={{ fontSize: '1.25rem', marginBottom: '30px', textAlign: 'justify' }}>Việc lựa chọn nghề nghiệp phù hợp là một bước quan trọng trong hành trình tìm kiếm bản thân và sự nghiệp. Để giúp bạn hiểu hơn về chính mình và khám phá nghề nghiệp phù hợp, hãy tham gia vào các bài trắc nghiệm nghề nghiệp ngay hôm nay. Hãy bắt đầu ngay và cùng chúng tôi tìm ra hướng đi tuyệt vời cho bạn! 🎯</p>
        </Container>
      </section>
